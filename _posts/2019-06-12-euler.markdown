...
>> $$\begin{equation} \frac{dy}{dt} = 3 + e^{-t} - \frac{1}{2}y, &ensp;&ensp; y(0) = 1 \tag{6} \label{eq:six} \end{equation}$$

>> <i>Use the Euler Method with step size 0.1, 0.05, 0.025 and 0.01 to approximate a numerical solution between $$ 0 \leq t \leq 5 $$. Compare results with analytical solution correspondent values.</i> 
