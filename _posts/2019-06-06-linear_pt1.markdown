...
For this case, we say that the vectors {${\mathbf{x_1}, \mathbf{x_2}, \mathbf{x_3}, \ldots, \mathbf{x_n}}$} are **linearly independent**. On the other hand, if there is at least one scalar that is different of zero (*e.g* $\alpha_1$ $\neq$ 0), we say that the set is **linearly dependent**. In other words, if one of them (say $\mathbf{x_1}$) is expressed as the linear combination of the others, we say that such set of vectors is linearly dependent (Eq. \ref{eq:five}).

$$ x_1 = -\frac{\alpha_2}{\alpha_1}x_2 - \frac{\alpha_3}{\alpha_1}x_3 - \ldots - \frac{\alpha_n}{\alpha_1}x_n \tag{5} \label{eq:five}$$ 

> __*Alright, Victor, but what else? What does it mean?*__

https://yutsumura.com/quiz-3-condition-that-vectors-are-linearly-dependent-orthogonal-vectors-are-linearly-independent/
https://math.oregonstate.edu/home/programs/undergrad/CalculusQuestStudyGuides/vcalc/lindep/lindep.html
https://www.statlect.com/matrix-algebra/linear-independence
http://www.sosmath.com/diffeq/second/linearind/linearind.html
http://tutorial.math.lamar.edu/Classes/DE/FundamentalSetsofSolutions.aspxhttps://math.stackexchange.com/questions/2359046/the-wronskian-and-the-term-fundamental-set-of-solutions
