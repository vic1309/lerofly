...
For this case, we say that the vectors {${\mathbf{x_1}, \mathbf{x_2}, \mathbf{x_3}, \ldots, \mathbf{x_n}}$} are linearly independent. On the other hand, if there is at least on scalar that is different of zero (*e.g* $\alpha_1$ $\neq$ 0}
