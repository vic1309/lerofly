...
Consider the vectors $\mathbf{x_1}$, $\mathbf{x_2}$ and $\mathbf{x_3}$ scaled by three scalars, say *$\alpha_1$*, *$\alpha_2$* and *$\alpha_3$*, respectively.  

$$ \alpha_1 \mathbf{x_1} + \alpha_2 \mathbf{x_2} + \alpha_3 \mathbf{x_3} = 0 \tag{3} \label{eq:three}$$
