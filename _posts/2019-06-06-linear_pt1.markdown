...
When we consider a linear system of something it means that things are **coupled**. In other words, if you have two equations with two unknown functions (say $x_1$ and $x_2$)
