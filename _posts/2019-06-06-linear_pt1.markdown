...
In order to solve them, we can transform these two second order equations in a system of four first order equations. Defining parameter values:

* Block masses -- $m_1 = 1.0$; $m_2 = 1.5$ 
